...
const HOST = 'https://api.apibox.cc'
...
const PARAMETERS = {
  GENERATECODE: '/1/wxlite/qr/generatecode', // 生成二维码
  GETACCESSTOKEN: '/1/wxlite/getAccessToken', // 获取access_token
  SENDWEAPPMESSAGE: '/1/wxlite/SendWeAppMessage', // 小程序模版消息
  NOTIFYMSG: '/1/wxlite/notifyMsg', // 微信主人通知
  ...
  FILESCHECK: '/1/wxlite/checkImg', // 单个文件上传/删除
  ...
  USERS: '/1/users', // 查询用户
  PAY: '/1/pay', // 支付
  WECHAT_APP: '/1/wxlite/', // 获取openid
  BATCH: '/1/batch',
  CHECK_MSG: '/1/wxlite/checkMsg', // 检测文本内容
  DECRYPTION: '/1/wxlite/decryption', // 检测文本内容
